# Resume lever2-sdstart160 (KL-98 reserve lever 2 - see lever2-sdstart160-bootstrap.ps1 for
# what this run is and why) under the auto-restart watchdog. Ordinary resume only - no
# --fresh, no --fork-from. Run lever2-sdstart160-bootstrap.ps1 first, once.
#
# Usage:
#   .\tools\launch\lever2-sdstart160-resume.ps1                  # resume toward iteration 160
#   .\tools\launch\lever2-sdstart160-resume.ps1 -Iterations 200  # extend further after the gate
param(
    [int]$Iterations = 160
)
