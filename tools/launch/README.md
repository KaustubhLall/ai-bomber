...
| [`v6-league-gate-eval.ps1`](v6-league-gate-eval.ps1) | The eval-time (noise-off, greedy) win-cause + WAIT% check vs MCTS that actually decides whether a run is working — see KL-97/KL-98. `-RunDir path`, `-Checkpoint filename`, `-MctsGames N`. |
